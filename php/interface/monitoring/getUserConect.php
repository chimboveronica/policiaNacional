...
if (!$mysqli = getConectionDb()) {
    ...
    $consultaSql = "select u.usuario,u.id_rol_usuario,r.nombre as rol_usuario,e.empresa, u.fecha_hora_conexion as fecha_hora_con, u.conectado, u.ip, u.longitud, u.latitud 
    ...
    while ($myrow = $result->fetch_assoc()) {
        $objJson .= "{"
                ...
                . "rolConect:" . $myrow["id_rol_usuario"] . ","
