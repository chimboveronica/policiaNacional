...
function loadGridFlags(records, idEmp, idEqp, fi, ff, hi, hf, vehiculo) {
    ...
    columnFlags = [
        ...
        {text: '<b>Eventos</b>', width: 330, dataIndex: 'eventos', filter: {type: 'list', store: storeEventos}, align: 'center'},
        ...
        {text: '<b>Batería</b>', width: 150, dataIndex: 'bateria', align: 'center', renderer: formatBat, filter: {
                type: 'list',
                options: [[1, 'Bat. del Equipo'], [0, 'Bat. del Vehiculo']]
            }},
        {text: '<b>Estado del<br> Vehículo(Ign)</b>', width: 175, dataIndex: 'ign', align: 'center', renderer: estadoVehiculo, filter: {
                type: 'list',
                options: [[1, 'Encendido'], [0, 'Apagado']]
            }},
        {text: '<b>GSM</b>', width: 110, dataIndex: 'gsm', align: 'center', renderer: estadoGsm, filter: {
                type: 'list',
                options: [[1, 'Con covertura'], [0, 'Sin covertura']]
            }},
        {text: '<b>GPS</b>', width: 100, dataIndex: 'gps2', align: 'center', renderer: estadoGps, filter: {
                type: 'list',
