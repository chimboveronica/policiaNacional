                ...
                eventListeners: {
                    featureselected: function (evt) {
                        ...
                        var contenidoAlternativo =
                                "<section>" +
                                "<b>Trama: </b>" + trama.toString() + "<br>" +
                                "<b>UPC: </b>" + empresa.toString() + "<br>" +
                                "<b>Unidad: </b>" + vehiculo.toString() + "<br>" +
                ...
                eventListeners: {
                    featureselected: function (evt) {
                        ...
                        var contenidoAlternativo =
                                ...
                                "<b>UPC: </b>" + companyTravel.toString() + "<br>" +
...
function onVehiculoSelect(evt) {
    ...
    var contenidoAlternativo =
            "<section>" +
            "<b>UPC: </b>" + companyLast + "<br>" +
            "<b>Unidad: </b>" + vehiculoLast + "<br>" +
