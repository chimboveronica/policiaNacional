...
Ext.onReady(function () {
    ...
    gridPersona = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {header: "Cédula", width: 100, sortable: true, dataIndex: 'cedula', filter: {type: 'string'}, align: 'center'},
            ...
            {header: "email", width: 180, sortable: true, dataIndex: 'email', filter: {type: 'string'}, align: 'center'},
            {header: "Dirección", width: 160, sortable: true, dataIndex: 'direccion', filter: {type: 'string'}},
                ...
                handler: function () {
                    if (gridStorePerson.getCount() > 0) {
                        if (getNavigator() === 'img/chrome.png') {
                            ...
                            var numCol = 7;
                            var tiLetra = 'Calibri';
                            var titulo = 'Registros de personas';
    ...
    formPersona = Ext.create('Ext.form.Panel', {
        ...
        items: [{
                ...
                items: [{
                        ...
                        blankText: 'Este campo es obligatorio',
                        vtype: 'emailNuevo',
                        emptyText: 'veronicapaulina@unl.edu.ec'
                    }
                ]
            }, {
                xtype: 'fieldset',
