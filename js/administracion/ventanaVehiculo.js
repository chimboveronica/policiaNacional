    ...
    gridRecordsVeh = Ext.create('Ext.grid.Panel', {
                ...
                handler: function () {
                    if (gridStoreVehiculo.getCount() > 0) {
                        if (getNavigator() === 'img/chrome.png') {
                            ...
                            var numCol = 11;
                            var tiLetra = 'Calibri';
                            var titulo = 'Registros de Unidades Policiales';
                            ...
                            table_div += "<Row ss:AutoFitHeight='0'>" +
                                    "<Cell ss:StyleID='encabezados'><Data ss:Type='String'>UPC</Data></Cell>" +
                                    ...
                                    "<Cell ss:StyleID='encabezados'><Data ss:Type='String'>Unidad</Data></Cell>" +
        ...
        listeners: {
            selectionchange: function (thisObject, selected, eOpts) {
                ...
                idEquipo = selected[0].data.idEquipo;
            },
...
//            }
    ...
    var formPanelGrid = Ext.create('Ext.form.Panel', {
        ...
        region: 'west',
        autoScroll: true,
        title: '<b>Registros de las Unidades Policiales</b>',
    ...
    formRecordsVeh = Ext.create('Ext.form.Panel', {
        ...
        autoScroll: true,
        region: 'center',
        title: '<b>Ingresar Datos de las Unidades Policiales</b>',
        activeRecord: null,
...
//        margins: '0 0 0 3',
        items: [{
                xtype: 'fieldset',
                title: '<b>Datos de la Unidad Policial</b>',
                collapsible: true,
                layout: 'hbox',
                //padding: '5 5 10 5',
                defaults: {
                                ...
                                listeners: {
                                    change: function (thisObj, value, eOpts) {
                                        ...
                                        form.submit({
                                            url: 'php/uploads/uploadVehiculo.php',
                                            success: function (form, action) {
                                                formAdminVehicle.down('[name=labelImage]').setSrc('img/buses/' + action.result['img']);
                                                formAdminVehicle.down('[name=imageVehicle]').setValue(action.result['img']);
                                                thisObj.setRawValue(action.result['img']);
                                            },
                                            failure: function (form, action) {
                                                Ext.Msg.alert('Error', 'No se pudo subir la imagen');
...
function onUpdateVeh() {
    ...
    var val = Ext.getCmp('id_equipos').getValue();
    if (val > 0) {
    } else {
        Ext.getCmp('id_equipos').setValue(idEquipo);
    }
////    active.set({
