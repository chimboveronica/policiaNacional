...
Ext.onReady(function () {
    ...
    gridAdminCompany = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {header: "<b>UPC</b>", align: 'center', width: 180, sortable: true, dataIndex: 'empresa', renderer: formatCompany, filter: {type: 'list', store: storeEmpresasList}, align: 'center'},
...
function onDeleteCompany() {
    Ext.MessageBox.confirm('Atención!', 'Desea Eliminar la UPC', function (choice) {
        if (choice === 'yes') {
